...
1. Continue the AgentShield enterprise control-plane sequence from
   ...
   review items, and ECC-Tools commit `8658951` consumes those outputs in
   hosted security review and Hosted Promotion Readiness scoring. The next
   slice is richer operator review UX on top of this telemetry.
