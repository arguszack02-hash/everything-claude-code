...
- `agentshield-enterprise-iteration`: add richer operator review UX on top of hosted promotion telemetry
- `ecc-tools-next-level`: live Marketplace test-account readback and richer operator review UX pending
